...
declare const DescribeMeshCommand_base: {
    new (input: DescribeMeshCommandInput): import("@smithy/core/client").CommandImpl<DescribeMeshCommandInput, DescribeMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMeshCommandInput): import("@smithy/core/client").CommandImpl<DescribeMeshCommandInput, DescribeMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
