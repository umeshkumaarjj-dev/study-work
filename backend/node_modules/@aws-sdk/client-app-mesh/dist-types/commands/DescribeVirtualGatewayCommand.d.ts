...
declare const DescribeVirtualGatewayCommand_base: {
    new (input: DescribeVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualGatewayCommandInput, DescribeVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualGatewayCommandInput, DescribeVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
