...
declare const CreateVirtualRouterCommand_base: {
    new (input: CreateVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualRouterCommandInput, CreateVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualRouterCommandInput, CreateVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
