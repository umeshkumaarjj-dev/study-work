...
declare const CreateGatewayRouteCommand_base: {
    new (input: CreateGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateGatewayRouteCommandInput, CreateGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateGatewayRouteCommandInput, CreateGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
