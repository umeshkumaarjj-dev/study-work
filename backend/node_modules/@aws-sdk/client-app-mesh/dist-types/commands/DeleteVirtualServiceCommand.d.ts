...
declare const DeleteVirtualServiceCommand_base: {
    new (input: DeleteVirtualServiceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualServiceCommandInput, DeleteVirtualServiceCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVirtualServiceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualServiceCommandInput, DeleteVirtualServiceCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
