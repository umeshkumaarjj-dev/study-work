...
declare const CreateMeshCommand_base: {
    new (input: CreateMeshCommandInput): import("@smithy/core/client").CommandImpl<CreateMeshCommandInput, CreateMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMeshCommandInput): import("@smithy/core/client").CommandImpl<CreateMeshCommandInput, CreateMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
