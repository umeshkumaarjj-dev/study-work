...
declare const DeleteVirtualNodeCommand_base: {
    new (input: DeleteVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualNodeCommandInput, DeleteVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualNodeCommandInput, DeleteVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
