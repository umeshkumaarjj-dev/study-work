...
declare const DeleteGatewayRouteCommand_base: {
    new (input: DeleteGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayRouteCommandInput, DeleteGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayRouteCommandInput, DeleteGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
