...
declare const DescribeRouteCommand_base: {
    new (input: DescribeRouteCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteCommandInput, DescribeRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeRouteCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteCommandInput, DescribeRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
