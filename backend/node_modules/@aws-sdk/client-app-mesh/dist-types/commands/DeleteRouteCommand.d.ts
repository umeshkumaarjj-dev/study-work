...
declare const DeleteRouteCommand_base: {
    new (input: DeleteRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCommandInput, DeleteRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCommandInput, DeleteRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
