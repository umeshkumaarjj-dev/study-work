...
declare const CreateVirtualServiceCommand_base: {
    new (input: CreateVirtualServiceCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualServiceCommandInput, CreateVirtualServiceCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVirtualServiceCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualServiceCommandInput, CreateVirtualServiceCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
