...
declare const DescribeVirtualNodeCommand_base: {
    new (input: DescribeVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualNodeCommandInput, DescribeVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualNodeCommandInput, DescribeVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
