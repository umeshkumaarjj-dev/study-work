...
declare const DeleteMeshCommand_base: {
    new (input: DeleteMeshCommandInput): import("@smithy/core/client").CommandImpl<DeleteMeshCommandInput, DeleteMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMeshCommandInput): import("@smithy/core/client").CommandImpl<DeleteMeshCommandInput, DeleteMeshCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
