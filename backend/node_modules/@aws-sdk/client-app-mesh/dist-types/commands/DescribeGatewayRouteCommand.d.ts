...
declare const DescribeGatewayRouteCommand_base: {
    new (input: DescribeGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DescribeGatewayRouteCommandInput, DescribeGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeGatewayRouteCommandInput): import("@smithy/core/client").CommandImpl<DescribeGatewayRouteCommandInput, DescribeGatewayRouteCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
