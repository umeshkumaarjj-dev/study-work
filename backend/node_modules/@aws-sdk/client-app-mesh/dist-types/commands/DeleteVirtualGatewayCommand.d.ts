...
declare const DeleteVirtualGatewayCommand_base: {
    new (input: DeleteVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualGatewayCommandInput, DeleteVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualGatewayCommandInput, DeleteVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
