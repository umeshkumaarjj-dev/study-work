...
declare const DescribeVirtualRouterCommand_base: {
    new (input: DescribeVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualRouterCommandInput, DescribeVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<DescribeVirtualRouterCommandInput, DescribeVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
