...
declare const DeleteVirtualRouterCommand_base: {
    new (input: DeleteVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualRouterCommandInput, DeleteVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVirtualRouterCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualRouterCommandInput, DeleteVirtualRouterCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
