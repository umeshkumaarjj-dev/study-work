...
declare const CreateVirtualNodeCommand_base: {
    new (input: CreateVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualNodeCommandInput, CreateVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVirtualNodeCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualNodeCommandInput, CreateVirtualNodeCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
