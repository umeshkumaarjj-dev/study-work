...
declare const CreateVirtualGatewayCommand_base: {
    new (input: CreateVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualGatewayCommandInput, CreateVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVirtualGatewayCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualGatewayCommandInput, CreateVirtualGatewayCommandOutput, import("..").AppMeshClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
