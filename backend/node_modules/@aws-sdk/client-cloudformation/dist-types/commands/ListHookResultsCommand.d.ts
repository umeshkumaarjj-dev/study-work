...
declare const ListHookResultsCommand_base: {
    new (input: ListHookResultsCommandInput): import("@smithy/core/client").CommandImpl<ListHookResultsCommandInput, ListHookResultsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHookResultsCommandInput]): import("@smithy/core/client").CommandImpl<ListHookResultsCommandInput, ListHookResultsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
