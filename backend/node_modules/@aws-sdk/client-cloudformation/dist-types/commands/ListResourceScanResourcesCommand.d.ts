...
declare const ListResourceScanResourcesCommand_base: {
    new (input: ListResourceScanResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListResourceScanResourcesCommandInput, ListResourceScanResourcesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListResourceScanResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListResourceScanResourcesCommandInput, ListResourceScanResourcesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
