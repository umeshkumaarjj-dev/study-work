...
declare const GetTemplateSummaryCommand_base: {
    new (input: GetTemplateSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetTemplateSummaryCommandInput, GetTemplateSummaryCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetTemplateSummaryCommandInput]): import("@smithy/core/client").CommandImpl<GetTemplateSummaryCommandInput, GetTemplateSummaryCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
