...
declare const DetectStackSetDriftCommand_base: {
    new (input: DetectStackSetDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackSetDriftCommandInput, DetectStackSetDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectStackSetDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackSetDriftCommandInput, DetectStackSetDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
