...
declare const DeactivateTypeCommand_base: {
    new (input: DeactivateTypeCommandInput): import("@smithy/core/client").CommandImpl<DeactivateTypeCommandInput, DeactivateTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeactivateTypeCommandInput]): import("@smithy/core/client").CommandImpl<DeactivateTypeCommandInput, DeactivateTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
