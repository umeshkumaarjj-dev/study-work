...
declare const CancelUpdateStackCommand_base: {
    new (input: CancelUpdateStackCommandInput): import("@smithy/core/client").CommandImpl<CancelUpdateStackCommandInput, CancelUpdateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelUpdateStackCommandInput): import("@smithy/core/client").CommandImpl<CancelUpdateStackCommandInput, CancelUpdateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
