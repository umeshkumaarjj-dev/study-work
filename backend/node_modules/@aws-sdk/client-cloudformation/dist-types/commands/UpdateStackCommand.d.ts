...
declare const UpdateStackCommand_base: {
    new (input: UpdateStackCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackCommandInput, UpdateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStackCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackCommandInput, UpdateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
