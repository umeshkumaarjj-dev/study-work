...
declare const DetectStackResourceDriftCommand_base: {
    new (input: DetectStackResourceDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackResourceDriftCommandInput, DetectStackResourceDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectStackResourceDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackResourceDriftCommandInput, DetectStackResourceDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
