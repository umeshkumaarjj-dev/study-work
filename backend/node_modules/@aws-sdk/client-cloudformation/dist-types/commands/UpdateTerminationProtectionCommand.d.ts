...
declare const UpdateTerminationProtectionCommand_base: {
    new (input: UpdateTerminationProtectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateTerminationProtectionCommandInput, UpdateTerminationProtectionCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTerminationProtectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateTerminationProtectionCommandInput, UpdateTerminationProtectionCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
