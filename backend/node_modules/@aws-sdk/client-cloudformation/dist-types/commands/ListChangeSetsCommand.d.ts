...
declare const ListChangeSetsCommand_base: {
    new (input: ListChangeSetsCommandInput): import("@smithy/core/client").CommandImpl<ListChangeSetsCommandInput, ListChangeSetsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListChangeSetsCommandInput): import("@smithy/core/client").CommandImpl<ListChangeSetsCommandInput, ListChangeSetsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
