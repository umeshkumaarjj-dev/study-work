...
declare const CreateGeneratedTemplateCommand_base: {
    new (input: CreateGeneratedTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateGeneratedTemplateCommandInput, CreateGeneratedTemplateCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGeneratedTemplateCommandInput): import("@smithy/core/client").CommandImpl<CreateGeneratedTemplateCommandInput, CreateGeneratedTemplateCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
