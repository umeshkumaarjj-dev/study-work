...
declare const ListStackResourcesCommand_base: {
    new (input: ListStackResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListStackResourcesCommandInput, ListStackResourcesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStackResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListStackResourcesCommandInput, ListStackResourcesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
