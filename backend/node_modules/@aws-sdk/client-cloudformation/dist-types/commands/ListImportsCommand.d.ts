...
declare const ListImportsCommand_base: {
    new (input: ListImportsCommandInput): import("@smithy/core/client").CommandImpl<ListImportsCommandInput, ListImportsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListImportsCommandInput): import("@smithy/core/client").CommandImpl<ListImportsCommandInput, ListImportsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
