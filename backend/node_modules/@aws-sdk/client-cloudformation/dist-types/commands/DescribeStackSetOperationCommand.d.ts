...
declare const DescribeStackSetOperationCommand_base: {
    new (input: DescribeStackSetOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeStackSetOperationCommandInput, DescribeStackSetOperationCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStackSetOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeStackSetOperationCommandInput, DescribeStackSetOperationCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
