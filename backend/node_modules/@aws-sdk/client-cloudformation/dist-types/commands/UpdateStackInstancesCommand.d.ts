...
declare const UpdateStackInstancesCommand_base: {
    new (input: UpdateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackInstancesCommandInput, UpdateStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackInstancesCommandInput, UpdateStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
