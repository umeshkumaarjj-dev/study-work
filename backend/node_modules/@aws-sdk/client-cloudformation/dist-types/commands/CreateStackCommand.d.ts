...
declare const CreateStackCommand_base: {
    new (input: CreateStackCommandInput): import("@smithy/core/client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStackCommandInput): import("@smithy/core/client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
