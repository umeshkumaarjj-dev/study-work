...
declare const ContinueUpdateRollbackCommand_base: {
    new (input: ContinueUpdateRollbackCommandInput): import("@smithy/core/client").CommandImpl<ContinueUpdateRollbackCommandInput, ContinueUpdateRollbackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ContinueUpdateRollbackCommandInput): import("@smithy/core/client").CommandImpl<ContinueUpdateRollbackCommandInput, ContinueUpdateRollbackCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
