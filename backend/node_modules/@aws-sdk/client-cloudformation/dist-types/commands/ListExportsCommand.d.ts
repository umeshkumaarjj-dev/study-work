...
declare const ListExportsCommand_base: {
    new (input: ListExportsCommandInput): import("@smithy/core/client").CommandImpl<ListExportsCommandInput, ListExportsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListExportsCommandInput]): import("@smithy/core/client").CommandImpl<ListExportsCommandInput, ListExportsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
