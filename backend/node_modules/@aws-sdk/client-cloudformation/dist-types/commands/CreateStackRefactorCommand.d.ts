...
declare const CreateStackRefactorCommand_base: {
    new (input: CreateStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<CreateStackRefactorCommandInput, CreateStackRefactorCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<CreateStackRefactorCommandInput, CreateStackRefactorCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
