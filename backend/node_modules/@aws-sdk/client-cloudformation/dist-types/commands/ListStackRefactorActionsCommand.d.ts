...
declare const ListStackRefactorActionsCommand_base: {
    new (input: ListStackRefactorActionsCommandInput): import("@smithy/core/client").CommandImpl<ListStackRefactorActionsCommandInput, ListStackRefactorActionsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStackRefactorActionsCommandInput): import("@smithy/core/client").CommandImpl<ListStackRefactorActionsCommandInput, ListStackRefactorActionsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
