...
declare const DescribeTypeRegistrationCommand_base: {
    new (input: DescribeTypeRegistrationCommandInput): import("@smithy/core/client").CommandImpl<DescribeTypeRegistrationCommandInput, DescribeTypeRegistrationCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTypeRegistrationCommandInput): import("@smithy/core/client").CommandImpl<DescribeTypeRegistrationCommandInput, DescribeTypeRegistrationCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
