...
declare const CreateChangeSetCommand_base: {
    new (input: CreateChangeSetCommandInput): import("@smithy/core/client").CommandImpl<CreateChangeSetCommandInput, CreateChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateChangeSetCommandInput): import("@smithy/core/client").CommandImpl<CreateChangeSetCommandInput, CreateChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
