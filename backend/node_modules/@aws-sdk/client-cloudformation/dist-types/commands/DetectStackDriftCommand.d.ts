...
declare const DetectStackDriftCommand_base: {
    new (input: DetectStackDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackDriftCommandInput, DetectStackDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectStackDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackDriftCommandInput, DetectStackDriftCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
