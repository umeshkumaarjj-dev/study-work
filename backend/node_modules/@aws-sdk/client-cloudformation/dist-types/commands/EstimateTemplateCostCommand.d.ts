...
declare const EstimateTemplateCostCommand_base: {
    new (input: EstimateTemplateCostCommandInput): import("@smithy/core/client").CommandImpl<EstimateTemplateCostCommandInput, EstimateTemplateCostCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EstimateTemplateCostCommandInput]): import("@smithy/core/client").CommandImpl<EstimateTemplateCostCommandInput, EstimateTemplateCostCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
