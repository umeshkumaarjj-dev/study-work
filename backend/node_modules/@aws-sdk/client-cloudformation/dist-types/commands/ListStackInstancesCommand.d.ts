...
declare const ListStackInstancesCommand_base: {
    new (input: ListStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListStackInstancesCommandInput, ListStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListStackInstancesCommandInput, ListStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
