...
declare const ActivateOrganizationsAccessCommand_base: {
    new (input: ActivateOrganizationsAccessCommandInput): import("@smithy/core/client").CommandImpl<ActivateOrganizationsAccessCommandInput, ActivateOrganizationsAccessCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ActivateOrganizationsAccessCommandInput]): import("@smithy/core/client").CommandImpl<ActivateOrganizationsAccessCommandInput, ActivateOrganizationsAccessCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
