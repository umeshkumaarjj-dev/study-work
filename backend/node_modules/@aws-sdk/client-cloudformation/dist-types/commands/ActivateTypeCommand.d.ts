...
declare const ActivateTypeCommand_base: {
    new (input: ActivateTypeCommandInput): import("@smithy/core/client").CommandImpl<ActivateTypeCommandInput, ActivateTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ActivateTypeCommandInput]): import("@smithy/core/client").CommandImpl<ActivateTypeCommandInput, ActivateTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
