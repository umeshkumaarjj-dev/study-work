...
declare const ListResourceScansCommand_base: {
    new (input: ListResourceScansCommandInput): import("@smithy/core/client").CommandImpl<ListResourceScansCommandInput, ListResourceScansCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListResourceScansCommandInput]): import("@smithy/core/client").CommandImpl<ListResourceScansCommandInput, ListResourceScansCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
