...
declare const DeleteChangeSetCommand_base: {
    new (input: DeleteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteChangeSetCommandInput, DeleteChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteChangeSetCommandInput, DeleteChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
