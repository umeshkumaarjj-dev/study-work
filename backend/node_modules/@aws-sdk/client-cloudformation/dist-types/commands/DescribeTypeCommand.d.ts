...
declare const DescribeTypeCommand_base: {
    new (input: DescribeTypeCommandInput): import("@smithy/core/client").CommandImpl<DescribeTypeCommandInput, DescribeTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTypeCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTypeCommandInput, DescribeTypeCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
