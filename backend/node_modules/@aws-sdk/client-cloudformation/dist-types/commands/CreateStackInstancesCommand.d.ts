...
declare const CreateStackInstancesCommand_base: {
    new (input: CreateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<CreateStackInstancesCommandInput, CreateStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<CreateStackInstancesCommandInput, CreateStackInstancesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
