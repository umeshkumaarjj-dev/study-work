...
declare const GetStackPolicyCommand_base: {
    new (input: GetStackPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetStackPolicyCommandInput, GetStackPolicyCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStackPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetStackPolicyCommandInput, GetStackPolicyCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
