...
declare const ImportStacksToStackSetCommand_base: {
    new (input: ImportStacksToStackSetCommandInput): import("@smithy/core/client").CommandImpl<ImportStacksToStackSetCommandInput, ImportStacksToStackSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportStacksToStackSetCommandInput): import("@smithy/core/client").CommandImpl<ImportStacksToStackSetCommandInput, ImportStacksToStackSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
