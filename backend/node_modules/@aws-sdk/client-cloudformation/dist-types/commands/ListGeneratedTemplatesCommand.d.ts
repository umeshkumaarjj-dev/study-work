...
declare const ListGeneratedTemplatesCommand_base: {
    new (input: ListGeneratedTemplatesCommandInput): import("@smithy/core/client").CommandImpl<ListGeneratedTemplatesCommandInput, ListGeneratedTemplatesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGeneratedTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<ListGeneratedTemplatesCommandInput, ListGeneratedTemplatesCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
