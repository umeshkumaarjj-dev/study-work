...
declare const ExecuteChangeSetCommand_base: {
    new (input: ExecuteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<ExecuteChangeSetCommandInput, ExecuteChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<ExecuteChangeSetCommandInput, ExecuteChangeSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
