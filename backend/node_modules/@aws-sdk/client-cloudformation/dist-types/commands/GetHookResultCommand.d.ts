...
declare const GetHookResultCommand_base: {
    new (input: GetHookResultCommandInput): import("@smithy/core/client").CommandImpl<GetHookResultCommandInput, GetHookResultCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetHookResultCommandInput]): import("@smithy/core/client").CommandImpl<GetHookResultCommandInput, GetHookResultCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
