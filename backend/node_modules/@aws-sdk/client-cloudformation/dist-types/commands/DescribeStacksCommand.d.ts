...
declare const DescribeStacksCommand_base: {
    new (input: DescribeStacksCommandInput): import("@smithy/core/client").CommandImpl<DescribeStacksCommandInput, DescribeStacksCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStacksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStacksCommandInput, DescribeStacksCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
