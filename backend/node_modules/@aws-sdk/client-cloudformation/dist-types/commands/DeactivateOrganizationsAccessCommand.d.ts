...
declare const DeactivateOrganizationsAccessCommand_base: {
    new (input: DeactivateOrganizationsAccessCommandInput): import("@smithy/core/client").CommandImpl<DeactivateOrganizationsAccessCommandInput, DeactivateOrganizationsAccessCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeactivateOrganizationsAccessCommandInput]): import("@smithy/core/client").CommandImpl<DeactivateOrganizationsAccessCommandInput, DeactivateOrganizationsAccessCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
