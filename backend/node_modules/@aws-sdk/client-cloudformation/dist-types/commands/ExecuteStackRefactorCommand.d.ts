...
declare const ExecuteStackRefactorCommand_base: {
    new (input: ExecuteStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<ExecuteStackRefactorCommandInput, ExecuteStackRefactorCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExecuteStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<ExecuteStackRefactorCommandInput, ExecuteStackRefactorCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
