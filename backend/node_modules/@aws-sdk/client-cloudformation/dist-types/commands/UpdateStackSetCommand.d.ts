...
declare const UpdateStackSetCommand_base: {
    new (input: UpdateStackSetCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackSetCommandInput, UpdateStackSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStackSetCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackSetCommandInput, UpdateStackSetCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
