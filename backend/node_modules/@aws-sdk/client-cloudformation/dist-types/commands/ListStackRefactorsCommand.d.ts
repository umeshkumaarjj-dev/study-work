...
declare const ListStackRefactorsCommand_base: {
    new (input: ListStackRefactorsCommandInput): import("@smithy/core/client").CommandImpl<ListStackRefactorsCommandInput, ListStackRefactorsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStackRefactorsCommandInput]): import("@smithy/core/client").CommandImpl<ListStackRefactorsCommandInput, ListStackRefactorsCommandOutput, import("..").CloudFormationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
