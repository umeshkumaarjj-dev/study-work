...
declare const RegisterJobDefinitionCommand_base: {
    new (input: RegisterJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<RegisterJobDefinitionCommandInput, RegisterJobDefinitionCommandOutput, import("..").BatchClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<RegisterJobDefinitionCommandInput, RegisterJobDefinitionCommandOutput, import("..").BatchClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
