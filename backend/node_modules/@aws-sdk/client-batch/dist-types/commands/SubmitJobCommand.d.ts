...
declare const SubmitJobCommand_base: {
    new (input: SubmitJobCommandInput): import("@smithy/core/client").CommandImpl<SubmitJobCommandInput, SubmitJobCommandOutput, import("..").BatchClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SubmitJobCommandInput): import("@smithy/core/client").CommandImpl<SubmitJobCommandInput, SubmitJobCommandOutput, import("..").BatchClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
