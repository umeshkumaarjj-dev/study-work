...
declare const DeleteProvisionedModelThroughputCommand_base: {
    new (input: DeleteProvisionedModelThroughputCommandInput): import("@smithy/core/client").CommandImpl<DeleteProvisionedModelThroughputCommandInput, DeleteProvisionedModelThroughputCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProvisionedModelThroughputCommandInput): import("@smithy/core/client").CommandImpl<DeleteProvisionedModelThroughputCommandInput, DeleteProvisionedModelThroughputCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
