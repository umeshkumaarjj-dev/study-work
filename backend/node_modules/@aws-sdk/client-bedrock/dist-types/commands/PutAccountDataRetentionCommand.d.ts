...
declare const PutAccountDataRetentionCommand_base: {
    new (input: PutAccountDataRetentionCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDataRetentionCommandInput, PutAccountDataRetentionCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountDataRetentionCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDataRetentionCommandInput, PutAccountDataRetentionCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
