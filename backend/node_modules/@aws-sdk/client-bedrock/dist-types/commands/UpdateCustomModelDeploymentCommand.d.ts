...
declare const UpdateCustomModelDeploymentCommand_base: {
    new (input: UpdateCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomModelDeploymentCommandInput, UpdateCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<UpdateCustomModelDeploymentCommandInput, UpdateCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
