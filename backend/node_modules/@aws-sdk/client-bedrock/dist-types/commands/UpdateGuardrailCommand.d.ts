...
declare const UpdateGuardrailCommand_base: {
    new (input: UpdateGuardrailCommandInput): import("@smithy/core/client").CommandImpl<UpdateGuardrailCommandInput, UpdateGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGuardrailCommandInput): import("@smithy/core/client").CommandImpl<UpdateGuardrailCommandInput, UpdateGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
