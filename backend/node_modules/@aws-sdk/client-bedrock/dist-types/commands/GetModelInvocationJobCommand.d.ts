...
declare const GetModelInvocationJobCommand_base: {
    new (input: GetModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelInvocationJobCommandInput, GetModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelInvocationJobCommandInput, GetModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
