...
declare const DeleteModelInvocationLoggingConfigurationCommand_base: {
    new (input: DeleteModelInvocationLoggingConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteModelInvocationLoggingConfigurationCommandInput, DeleteModelInvocationLoggingConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteModelInvocationLoggingConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<DeleteModelInvocationLoggingConfigurationCommandInput, DeleteModelInvocationLoggingConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
