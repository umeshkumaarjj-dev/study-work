...
declare const RegisterMarketplaceModelEndpointCommand_base: {
    new (input: RegisterMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<RegisterMarketplaceModelEndpointCommandInput, RegisterMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<RegisterMarketplaceModelEndpointCommandInput, RegisterMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
