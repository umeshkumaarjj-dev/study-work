...
declare const GetModelImportJobCommand_base: {
    new (input: GetModelImportJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelImportJobCommandInput, GetModelImportJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelImportJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelImportJobCommandInput, GetModelImportJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
