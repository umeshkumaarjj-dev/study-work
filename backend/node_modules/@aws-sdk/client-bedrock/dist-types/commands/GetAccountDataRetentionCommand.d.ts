...
declare const GetAccountDataRetentionCommand_base: {
    new (input: GetAccountDataRetentionCommandInput): import("@smithy/core/client").CommandImpl<GetAccountDataRetentionCommandInput, GetAccountDataRetentionCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountDataRetentionCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountDataRetentionCommandInput, GetAccountDataRetentionCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
