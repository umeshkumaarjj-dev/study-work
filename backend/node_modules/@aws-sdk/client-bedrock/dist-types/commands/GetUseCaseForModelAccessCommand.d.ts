...
declare const GetUseCaseForModelAccessCommand_base: {
    new (input: GetUseCaseForModelAccessCommandInput): import("@smithy/core/client").CommandImpl<GetUseCaseForModelAccessCommandInput, GetUseCaseForModelAccessCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetUseCaseForModelAccessCommandInput]): import("@smithy/core/client").CommandImpl<GetUseCaseForModelAccessCommandInput, GetUseCaseForModelAccessCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
