...
declare const StopModelCustomizationJobCommand_base: {
    new (input: StopModelCustomizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopModelCustomizationJobCommandInput, StopModelCustomizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopModelCustomizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopModelCustomizationJobCommandInput, StopModelCustomizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
