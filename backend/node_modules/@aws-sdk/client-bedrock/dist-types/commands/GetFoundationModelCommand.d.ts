...
declare const GetFoundationModelCommand_base: {
    new (input: GetFoundationModelCommandInput): import("@smithy/core/client").CommandImpl<GetFoundationModelCommandInput, GetFoundationModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFoundationModelCommandInput): import("@smithy/core/client").CommandImpl<GetFoundationModelCommandInput, GetFoundationModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
