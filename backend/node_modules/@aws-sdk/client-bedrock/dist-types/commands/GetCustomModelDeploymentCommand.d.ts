...
declare const GetCustomModelDeploymentCommand_base: {
    new (input: GetCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<GetCustomModelDeploymentCommandInput, GetCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<GetCustomModelDeploymentCommandInput, GetCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
