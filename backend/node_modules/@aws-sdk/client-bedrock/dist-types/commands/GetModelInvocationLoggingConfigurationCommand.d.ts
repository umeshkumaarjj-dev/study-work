...
declare const GetModelInvocationLoggingConfigurationCommand_base: {
    new (input: GetModelInvocationLoggingConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetModelInvocationLoggingConfigurationCommandInput, GetModelInvocationLoggingConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetModelInvocationLoggingConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<GetModelInvocationLoggingConfigurationCommandInput, GetModelInvocationLoggingConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
