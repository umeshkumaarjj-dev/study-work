...
declare const CreateModelInvocationJobCommand_base: {
    new (input: CreateModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelInvocationJobCommandInput, CreateModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelInvocationJobCommandInput, CreateModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
