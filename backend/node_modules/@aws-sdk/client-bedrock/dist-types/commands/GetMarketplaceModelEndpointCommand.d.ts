...
declare const GetMarketplaceModelEndpointCommand_base: {
    new (input: GetMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetMarketplaceModelEndpointCommandInput, GetMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<GetMarketplaceModelEndpointCommandInput, GetMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
