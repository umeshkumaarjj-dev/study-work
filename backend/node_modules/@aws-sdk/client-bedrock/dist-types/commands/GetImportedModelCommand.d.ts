...
declare const GetImportedModelCommand_base: {
    new (input: GetImportedModelCommandInput): import("@smithy/core/client").CommandImpl<GetImportedModelCommandInput, GetImportedModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetImportedModelCommandInput): import("@smithy/core/client").CommandImpl<GetImportedModelCommandInput, GetImportedModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
