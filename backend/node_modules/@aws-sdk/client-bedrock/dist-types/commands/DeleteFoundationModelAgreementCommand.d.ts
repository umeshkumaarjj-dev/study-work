...
declare const DeleteFoundationModelAgreementCommand_base: {
    new (input: DeleteFoundationModelAgreementCommandInput): import("@smithy/core/client").CommandImpl<DeleteFoundationModelAgreementCommandInput, DeleteFoundationModelAgreementCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFoundationModelAgreementCommandInput): import("@smithy/core/client").CommandImpl<DeleteFoundationModelAgreementCommandInput, DeleteFoundationModelAgreementCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
