...
declare const GetEvaluationJobCommand_base: {
    new (input: GetEvaluationJobCommandInput): import("@smithy/core/client").CommandImpl<GetEvaluationJobCommandInput, GetEvaluationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetEvaluationJobCommandInput): import("@smithy/core/client").CommandImpl<GetEvaluationJobCommandInput, GetEvaluationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
