...
declare const GetAutomatedReasoningPolicyCommand_base: {
    new (input: GetAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAutomatedReasoningPolicyCommandInput, GetAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAutomatedReasoningPolicyCommandInput, GetAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
