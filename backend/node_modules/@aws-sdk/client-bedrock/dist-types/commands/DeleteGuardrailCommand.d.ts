...
declare const DeleteGuardrailCommand_base: {
    new (input: DeleteGuardrailCommandInput): import("@smithy/core/client").CommandImpl<DeleteGuardrailCommandInput, DeleteGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGuardrailCommandInput): import("@smithy/core/client").CommandImpl<DeleteGuardrailCommandInput, DeleteGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
