...
declare const GetModelCustomizationJobCommand_base: {
    new (input: GetModelCustomizationJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelCustomizationJobCommandInput, GetModelCustomizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelCustomizationJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelCustomizationJobCommandInput, GetModelCustomizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
