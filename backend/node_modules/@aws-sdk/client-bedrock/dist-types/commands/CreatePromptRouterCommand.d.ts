...
declare const CreatePromptRouterCommand_base: {
    new (input: CreatePromptRouterCommandInput): import("@smithy/core/client").CommandImpl<CreatePromptRouterCommandInput, CreatePromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePromptRouterCommandInput): import("@smithy/core/client").CommandImpl<CreatePromptRouterCommandInput, CreatePromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
