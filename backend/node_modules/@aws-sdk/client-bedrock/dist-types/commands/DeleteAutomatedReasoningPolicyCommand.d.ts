...
declare const DeleteAutomatedReasoningPolicyCommand_base: {
    new (input: DeleteAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAutomatedReasoningPolicyCommandInput, DeleteAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAutomatedReasoningPolicyCommandInput, DeleteAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
