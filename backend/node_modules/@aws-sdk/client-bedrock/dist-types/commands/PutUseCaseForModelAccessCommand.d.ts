...
declare const PutUseCaseForModelAccessCommand_base: {
    new (input: PutUseCaseForModelAccessCommandInput): import("@smithy/core/client").CommandImpl<PutUseCaseForModelAccessCommandInput, PutUseCaseForModelAccessCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutUseCaseForModelAccessCommandInput): import("@smithy/core/client").CommandImpl<PutUseCaseForModelAccessCommandInput, PutUseCaseForModelAccessCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
