...
declare const GetCustomModelCommand_base: {
    new (input: GetCustomModelCommandInput): import("@smithy/core/client").CommandImpl<GetCustomModelCommandInput, GetCustomModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCustomModelCommandInput): import("@smithy/core/client").CommandImpl<GetCustomModelCommandInput, GetCustomModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
