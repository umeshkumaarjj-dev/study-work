...
declare const GetAdvancedPromptOptimizationJobCommand_base: {
    new (input: GetAdvancedPromptOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<GetAdvancedPromptOptimizationJobCommandInput, GetAdvancedPromptOptimizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAdvancedPromptOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<GetAdvancedPromptOptimizationJobCommandInput, GetAdvancedPromptOptimizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
