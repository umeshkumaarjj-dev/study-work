...
declare const GetPromptRouterCommand_base: {
    new (input: GetPromptRouterCommandInput): import("@smithy/core/client").CommandImpl<GetPromptRouterCommandInput, GetPromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPromptRouterCommandInput): import("@smithy/core/client").CommandImpl<GetPromptRouterCommandInput, GetPromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
