...
declare const GetInferenceProfileCommand_base: {
    new (input: GetInferenceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInferenceProfileCommandInput, GetInferenceProfileCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInferenceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInferenceProfileCommandInput, GetInferenceProfileCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
