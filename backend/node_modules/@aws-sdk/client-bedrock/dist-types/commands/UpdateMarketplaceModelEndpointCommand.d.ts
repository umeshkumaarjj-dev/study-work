...
declare const UpdateMarketplaceModelEndpointCommand_base: {
    new (input: UpdateMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateMarketplaceModelEndpointCommandInput, UpdateMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMarketplaceModelEndpointCommandInput): import("@smithy/core/client").CommandImpl<UpdateMarketplaceModelEndpointCommandInput, UpdateMarketplaceModelEndpointCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
