...
declare const StopModelInvocationJobCommand_base: {
    new (input: StopModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<StopModelInvocationJobCommandInput, StopModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopModelInvocationJobCommandInput): import("@smithy/core/client").CommandImpl<StopModelInvocationJobCommandInput, StopModelInvocationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
