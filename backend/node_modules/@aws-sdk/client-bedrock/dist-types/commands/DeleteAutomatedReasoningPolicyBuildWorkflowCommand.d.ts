...
declare const DeleteAutomatedReasoningPolicyBuildWorkflowCommand_base: {
    new (input: DeleteAutomatedReasoningPolicyBuildWorkflowCommandInput): import("@smithy/core/client").CommandImpl<DeleteAutomatedReasoningPolicyBuildWorkflowCommandInput, DeleteAutomatedReasoningPolicyBuildWorkflowCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAutomatedReasoningPolicyBuildWorkflowCommandInput): import("@smithy/core/client").CommandImpl<DeleteAutomatedReasoningPolicyBuildWorkflowCommandInput, DeleteAutomatedReasoningPolicyBuildWorkflowCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
