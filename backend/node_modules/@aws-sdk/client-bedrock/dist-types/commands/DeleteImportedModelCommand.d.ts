...
declare const DeleteImportedModelCommand_base: {
    new (input: DeleteImportedModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteImportedModelCommandInput, DeleteImportedModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteImportedModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteImportedModelCommandInput, DeleteImportedModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
