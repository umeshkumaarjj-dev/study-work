...
declare const GetModelCopyJobCommand_base: {
    new (input: GetModelCopyJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelCopyJobCommandInput, GetModelCopyJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelCopyJobCommandInput): import("@smithy/core/client").CommandImpl<GetModelCopyJobCommandInput, GetModelCopyJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
