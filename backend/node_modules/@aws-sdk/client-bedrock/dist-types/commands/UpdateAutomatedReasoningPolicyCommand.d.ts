...
declare const UpdateAutomatedReasoningPolicyCommand_base: {
    new (input: UpdateAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyCommandInput, UpdateAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAutomatedReasoningPolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAutomatedReasoningPolicyCommandInput, UpdateAutomatedReasoningPolicyCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
