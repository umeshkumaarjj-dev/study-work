...
declare const DeleteCustomModelDeploymentCommand_base: {
    new (input: DeleteCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelDeploymentCommandInput, DeleteCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCustomModelDeploymentCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelDeploymentCommandInput, DeleteCustomModelDeploymentCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
