...
declare const StopAdvancedPromptOptimizationJobCommand_base: {
    new (input: StopAdvancedPromptOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopAdvancedPromptOptimizationJobCommandInput, StopAdvancedPromptOptimizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopAdvancedPromptOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopAdvancedPromptOptimizationJobCommandInput, StopAdvancedPromptOptimizationJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
