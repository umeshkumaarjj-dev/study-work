...
declare const DeleteCustomModelCommand_base: {
    new (input: DeleteCustomModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelCommandInput, DeleteCustomModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCustomModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteCustomModelCommandInput, DeleteCustomModelCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
