...
declare const DeletePromptRouterCommand_base: {
    new (input: DeletePromptRouterCommandInput): import("@smithy/core/client").CommandImpl<DeletePromptRouterCommandInput, DeletePromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePromptRouterCommandInput): import("@smithy/core/client").CommandImpl<DeletePromptRouterCommandInput, DeletePromptRouterCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
