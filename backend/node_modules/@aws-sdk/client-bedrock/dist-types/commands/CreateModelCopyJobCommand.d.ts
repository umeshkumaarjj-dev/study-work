...
declare const CreateModelCopyJobCommand_base: {
    new (input: CreateModelCopyJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCopyJobCommandInput, CreateModelCopyJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelCopyJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCopyJobCommandInput, CreateModelCopyJobCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
