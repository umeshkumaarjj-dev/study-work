...
declare const PutEnforcedGuardrailConfigurationCommand_base: {
    new (input: PutEnforcedGuardrailConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutEnforcedGuardrailConfigurationCommandInput, PutEnforcedGuardrailConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutEnforcedGuardrailConfigurationCommandInput): import("@smithy/core/client").CommandImpl<PutEnforcedGuardrailConfigurationCommandInput, PutEnforcedGuardrailConfigurationCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
