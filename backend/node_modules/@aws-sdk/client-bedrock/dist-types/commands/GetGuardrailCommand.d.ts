...
declare const GetGuardrailCommand_base: {
    new (input: GetGuardrailCommandInput): import("@smithy/core/client").CommandImpl<GetGuardrailCommandInput, GetGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGuardrailCommandInput): import("@smithy/core/client").CommandImpl<GetGuardrailCommandInput, GetGuardrailCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
