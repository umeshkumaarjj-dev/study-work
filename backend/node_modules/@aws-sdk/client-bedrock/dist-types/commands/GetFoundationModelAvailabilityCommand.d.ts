...
declare const GetFoundationModelAvailabilityCommand_base: {
    new (input: GetFoundationModelAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<GetFoundationModelAvailabilityCommandInput, GetFoundationModelAvailabilityCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFoundationModelAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<GetFoundationModelAvailabilityCommandInput, GetFoundationModelAvailabilityCommandOutput, import("..").BedrockClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
